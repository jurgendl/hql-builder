...
public class HibernateTemplate implements HibernateOperations {
     ...
     * <p>
     * Application exceptions thrown by the action object get propagated to the caller (can only be unchecked). Hibernate exceptions are transformed
     ...
     * {@link HibernateTransactionManager}. Generally, callback code must not touch any {@code Session} lifecycle methods, like close, disconnect, or
     * reconnect, to let the template do its work.
     * 
    ...
    /**
     * Convert the given Hibernate JDBCException to an appropriate exception from the {@code org.springframework.dao} hierarchy, using the given
     ...
     * <p>
     * This method is a thin wrapper around {@link org.hibernate.Session#get(Class, java.io.Serializable)} for convenience. For an explanation of the
     * exact semantics of this method, please do refer to the Hibernate API documentation in the first instance.
     * 
     ...
     * <p>
     * This method is a thin wrapper around {@link org.hibernate.Session#get(Class, java.io.Serializable, LockMode)} for convenience. For an
     * explanation of the exact semantics of this method, please do refer to the Hibernate API documentation in the first instance.
     * 
     * @param entityClass a persistent class
     * @param id the identifier of the persistent instance
     ...
     * Return the persistent instance of the given entity class with the given identifier, or {@code null} if not found.
     * <p>
     * This method is a thin wrapper around {@link org.hibernate.Session#get(String, java.io.Serializable)} for convenience. For an explanation of the
     * exact semantics of this method, please do refer to the Hibernate API documentation in the first instance.
     * 
    ...
    /**
     * Return the persistent instance of the given entity class with the given identifier, or {@code null} if not found. Obtains the specified lock
     * mode if the instance exists.
     * <p>
     * This method is a thin wrapper around {@link org.hibernate.Session#get(String, java.io.Serializable, LockMode)} for convenience. For an
     * explanation of the exact semantics of this method, please do refer to the Hibernate API documentation in the first instance.
     * 
     * @param entityName the name of the persistent entity
     * @param id the identifier of the persistent instance
     ...
     * <p>
     * This method is a thin wrapper around {@link org.hibernate.Session#load(Class, java.io.Serializable)} for convenience. For an explanation of the
     * exact semantics of this method, please do refer to the Hibernate API documentation in the first instance.
     * 
     * @param entityClass a persistent class
     * @param id the identifier of the persistent instance
    ...
    /**
     * Return the persistent instance of the given entity class with the given identifier, throwing an exception if not found. Obtains the specified
     * lock mode if the instance exists.
     * <p>
     * This method is a thin wrapper around {@link org.hibernate.Session#load(Class, java.io.Serializable, LockMode)} for convenience. For an
     * explanation of the exact semantics of this method, please do refer to the Hibernate API documentation in the first instance.
     * 
     * @param entityClass a persistent class
     * @param id the identifier of the persistent instance
     ...
     * Return the persistent instance of the given entity class with the given identifier, throwing an exception if not found.
     * <p>
     * This method is a thin wrapper around {@link org.hibernate.Session#load(String, java.io.Serializable)} for convenience. For an explanation of
     * the exact semantics of this method, please do refer to the Hibernate API documentation in the first instance.
     * 
     * @param entityName the name of the persistent entity
     * @param id the identifier of the persistent instance
     * @return the persistent instance
     ...
     * Obtains the specified lock mode if the instance exists.
     * <p>
     * This method is a thin wrapper around {@link org.hibernate.Session#load(String, java.io.Serializable, LockMode)} for convenience. For an
     * explanation of the exact semantics of this method, please do refer to the Hibernate API documentation in the first instance.
     * 
     * @param entityName the name of the persistent entity
     * @param id the identifier of the persistent instance
     ...
     * <p>
     * This method is a thin wrapper around {@link org.hibernate.Session#load(Object, java.io.Serializable)} for convenience. For an explanation of
     * the exact semantics of this method, please do refer to the Hibernate API documentation in the first instance.
     * 
    ...
    /**
     * Return an enabled Hibernate {@link Filter} for the given filter name. The returned {@code Filter} instance can be used to set filter
     * parameters.
     * 
    ...
    /**
     * Save or update the given persistent instance, according to its id (matching the configured "unsaved-value"?). Associates the instance with the
     * current Hibernate {@link org.hibernate.Session}.
     * 
    ...
    /**
     * Save or update the given persistent instance, according to its id (matching the configured "unsaved-value"?). Associates the instance with the
     * current Hibernate {@code Session}.
     * 
     * @param entityName the name of the persistent entity
     * @param entity the persistent instance to save or update (to be associated with the Hibernate {@code Session})
     * @throws DataAccessException in case of Hibernate errors
    ...
    /**
     * Save or update all given persistent instances, according to its id (matching the configured "unsaved-value"?). Associates the instances with
     ...
     * <p>
     * Similar to {@code saveOrUpdate}, but never associates the given object with the current Hibernate Session. In case of a new entity, the state
     * will be copied over as well.
     * <p>
     * Note that {@code merge} will <i>not</i> update the identifiers in the passed-in object graph (in contrast to TopLink)! Consider registering
     * Spring's {@code IdTransferringMergeEventListener} if you would like to have newly assigned ids transferred to the original object graph too.
     * 
     ...
     * Copy the state of the given object onto the persistent object with the same identifier. Follows JSR-220 semantics.
     * <p>
     * Similar to {@code saveOrUpdate}, but never associates the given object with the current Hibernate {@link org.hibernate.Session}. In the case of
     ...
     * <p>
     * Only invoke this for selective eager flushing, for example when JDBC code needs to see certain changes within the same transaction. Else, it is
     ...
     * 
     * @param criteria the detached Hibernate criteria object. <b>Note: Do not reuse criteria objects! They need to recreated per execution, due to
    ...
    /**
     * Immediately close an {@link Iterator} created by any of the various {@code iterate(..)} operations, instead of waiting until the session is
