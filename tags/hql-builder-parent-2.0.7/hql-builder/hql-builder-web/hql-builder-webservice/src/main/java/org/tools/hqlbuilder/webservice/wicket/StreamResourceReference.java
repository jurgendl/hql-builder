...
public abstract class StreamResourceReference extends PackageResourceReference {
	...
	public PackageResource getResource() {
		PackageResource resource = new PackageResource(getScope(), getName(),
	...
	public StreamResourceReference addJavaScriptResourceReferenceDependency(
			ResourceReference dependency) {
		dependenciesJavaScript.add(dependency);
		return this;
	}

	public StreamResourceReference addCssResourceReferenceDependency(
			ResourceReference dependency) {
