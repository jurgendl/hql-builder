...
public interface PojoResource {
	...
	/**
	 * @see [get]
	 *      http://localhost:80/hqlbuilder/rest/pojo/properties?classname=...
	 */
	@GET
	@Path("/properties")
	@Produces({ MediaType.TEXT_XML })
	public abstract XmlWrapper<List<String>> getProperties(
	...
	/**
	 * @see [get]
	 *      http://localhost:80/hqlbuilder/rest/pojo/search?text=...&typeName
	 *      =...&hitsPerPage=...
	 */
	@GET
	@Path("/search")
	@Produces({ MediaType.TEXT_XML })
	public abstract XmlWrapper<List<String>> search(
	...
	/**
	 * @see [get]
	 *      http://localhost:80/hqlbuilder/rest/pojo/propertynames?key=...&
	 *      parts=...&parts=...
	 */
	@GET
	@Path("/propertynames.")
	@Produces({ MediaType.TEXT_PLAIN })
	public abstract XmlWrapper<List<String>> getPropertyNames(
			@QueryParam("key") String key, @QueryParam("parts") String[] parts);
	...
	/**
	 * @see [get]
	 *      http://localhost:80/hqlbuilder/rest/pojo/findparameters?hql=...
	 */
	@GET
	@Path("/findparameters")
	@Produces({ MediaType.TEXT_XML })
	...
	/**
	 * @see [delete] http://localhost:80/hqlbuilder/rest/pojo/delete/{...}
	 *      [body]
	 */
	@DELETE
	@Path("/delete/{pojo}")
