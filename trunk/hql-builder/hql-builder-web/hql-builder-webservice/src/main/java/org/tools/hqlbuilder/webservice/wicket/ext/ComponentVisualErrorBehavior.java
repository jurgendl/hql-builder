...
/**
 * Behavior that checks if a {@link FormComponent} is valid. Valid {@link FormComponent} objects get the CSS class 'formcomponent valid' and invalid
 * {@link FormComponent} objects get the CSS class 'formcomponent invalid'.
 * 
...
public class ComponentVisualErrorBehavior extends AjaxFormComponentUpdatingBehavior {
    private static final long serialVersionUID = -6071802297197732124L;
     ...
     * @param updateComponent is the {@link Component} that must be updated (for example the {@link FeedbackLabel} containing the error message for
    ...
    /**
     * Listener invoked on the ajax request. This listener is invoked after the {@link Component}'s model has been updated. Handles the change of a
     * css class when an error has occurred.
     * 
    ...
    /**
     * Listener invoked on the ajax request. This listener is invoked after the {@link Component}'s model has been updated. Handles the change of a
     * css class when validation was succesful.
     * 
     * @param ajaxRequestTarget of type AjaxRequestTarget
     */
    @Override
