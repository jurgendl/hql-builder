...
public class ObjectTree extends JFrame {
    ...
    private IHqlBuilderHelper hqlBuilderHelper = null;

    private final JPanel propertypanel = new JPanel(new BorderLayout());

    private SessionFactory sessionFactory;

    public ObjectTree(final IHqlBuilderHelper hqlBuilderHelper, final SessionFactory sessionFactory, Object bean, final boolean editable) {
                ...
                try {
                    ...
                    if (data != null) {
                        ...
                        if (hqlBuilderHelper.accept(data.getClass())) {
                            ...
                            JComponent propertyFrame = hqlBuilderHelper.getPropertyFrame(sessionFactory, data, editable);
                            hqlBuilderHelper.font(propertyFrame, 12);
