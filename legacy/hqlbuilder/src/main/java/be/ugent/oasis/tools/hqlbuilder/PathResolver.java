...
import be.ugent.oasis.tools.hqlbuilder.HibernateWebResolver.Property;
            ...
            if (!init) {
                for (Property sub : value.getEdges()) {
                    try {
                        ...
                        TreeNode c = new TreeNode(sub, exclude, targetNode, this, ClassNode.class.cast(sub.target));
